...
@NamedQueries({
    ...
    @NamedQuery(name = "Patrimonio.findByDescricao", query = "SELECT p FROM Patrimonio p WHERE p.descricao = :descricao"),
    @NamedQuery(name = "Patrimonio.findByFator", query = "SELECT p FROM Patrimonio p WHERE p.fator = :fator")})
public class Patrimonio implements Serializable {
    ...
    public String toString() {
        return "br.com.mw.sysimovel.model.Patrimonio[ id=" + id + " ]";
    }
